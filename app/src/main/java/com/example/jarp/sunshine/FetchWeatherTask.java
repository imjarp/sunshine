...
// For presentation, assume the user doesn't care about tenths of a degree.
        ...
        if (unitType.equals(mContext.getString(R.string.Imperial))) {
            high = (high * 1.8) + 32;
            low = (low * 1.8) + 32;
        } else if (!unitType.equals(mContext.getString(R.string.Imperial))) {
...
// "temp" when working with temperature. It confuses everybody.
    ...
    private void InsertBulkRecords(Vector<ContentValues>values)
    {

        mContext.getContentResolver().bulkInsert(WeatherContract.WeatherEntry.CONTENT_URI,values.toArray(new ContentValues[values.size()]));
    }
